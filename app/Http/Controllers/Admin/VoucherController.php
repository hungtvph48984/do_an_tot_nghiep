...
{
    // Sinh mã voucher mới ngẫu nhiên
    $randomCode = 'VC' . strtoupper(Str::random(10));

    return view('admins.vouchers.edit', compact('voucher', 'randomCode'));
}
...
public function update(Request $request, Voucher $voucher)
{
    ...
    // Cập nhật voucher, trong đó code sẽ là ngẫu nhiên
    $voucher->update([
        'name' => $request->name,
        'code' => $request->random_code, // lấy từ input ẩn
        'type' => $request->type,
