            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <a class="btn btn-info mr-4 " href="{{ route('admin.categories.index') }}">← Quay lại</a>

                        <form action="{{ route('admin.categories.hidden') }}" method="GET" class="form-inline ml-auto mb-0">
