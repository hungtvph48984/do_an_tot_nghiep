          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <p><strong>Giá gốc:</strong> 
                <span class="text-danger">{{ number_format($product->price, 0, ',', '.') }} VND</span>
              </p>
            ...
            <div class="row">
              @foreach (json_decode($product->images, true) as $img)
                <div class="col-3 mb-2">
                  <img src="{{ Storage::url($img) }}" class="img-thumbnail" style="width:100%; height:150px; object-fit:cover;">
                </div>
              @endforeach
            </div>
          </div>
              ...
              <tbody>
                @foreach ($product->variants as $variant)
                  <tr>
                    ...
                    <td>{{ $variant->sale_price ? number_format($variant->sale_price, 0, ',', '.') . ' VND' : '-' }}</td>
